...
//session.addattribute.setatt , HttpSession session
	/*
	 * boolean deleteVenue = dao.destroy(id); if (deleteVenue) { List<Venue>
	 * allVenues = dao.findAll(); model.addAttribute("allVenues", allVenues); return
	 * "index"; } else { return "venu/error"; }
	 */
